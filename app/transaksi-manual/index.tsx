...
const DetailModal = memo(({ transaksi, onClose, onRefresh }: { transaksi: any; onClose: () => void; onRefresh?: () => void }) => {
    ...
    return (
        <View style={styles.modalContainer}>
            ...
            <ScrollView style={styles.modalContent}>
                ...
                {userData?.agen === '1' && transaksi.status?.toUpperCase() === 'PENDING' && (
...
export default function TransaksiManualScreen() {
    ...
    return (
        <View style={styles.container}>
            ...
            >
                {selectedTransaksi && <DetailModal transaksi={selectedTransaksi} onClose={handleCloseModal} onRefresh={handleRefreshAfterApprove} />}
            </Modal>
        </View>
    );
}

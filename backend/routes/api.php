...
use App\Http\Controllers\V1\TransaksiManualController;
...
Route::prefix('kurir')->group(function () {
    ...
    Route::prefix('v1')->group(function () {
        ...
        Route::post('/transaksi-manual/detail', [KurirController::class, 'getOrderDetail']);
        Route::post('/transaksi-manual/save', [TransaksiManualController::class, 'simpanTransaksi']);
        Route::post('/transaksi-manual/update', [TransaksiManualController::class, 'simpanTransaksi']);
        Route::post('/transaksi-member-agen', [TransaksiManualController::class, 'listTransaksiMemberAgen']);
        Route::post('/transaksi-manual/cancel', [TransaksiManualController::class, 'deleteTransaction']);
        // Legacy routes (backward compatible)
        Route::post('/save-transaksi-manual', [TransaksiManualController::class, 'simpanTransaksi']);
        Route::post('/approve-transaksi-manual', [TransaksiManualController::class, 'simpanTransaksi']);
        // ===== END TRANSAKSI MANUAL ROUTES =====

        Route::get('/rekap-komisi', [KurirController::class, 'rekapKomisi']);
        Route::post('/rekap-komisi-detail', [KurirController::class, 'rekapKomisiDetail']);
